...
#'
#' The clustifyrdatahub package provides access to the summarized reference count matrix data
#' from multiple datasets used in the clustifyr manuscript and tutorial. They are provided for
#' future users of clustifyr, for automated cell type classification of scRNA-seq experiments.
#'
#' Available datasets:
#'
#' + Mouse Cell Atlas
